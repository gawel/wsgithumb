# -*- coding: utf-8 -*-
#
# wsgithumb documentation build configuration file, created by
...
htmlhelp_basename = 'wsgithumbdoc'
...
latex_documents = [
  ('index', 'wsgithumb.tex', u'wsgithumb Documentation',
...
man_pages = [
    ('index', 'wsgithumb', u'wsgithumb Documentation',
     [u'Gael Pasgrimaud'], 1)
]
...
texinfo_documents = [
  ('index', 'wsgithumb', u'wsgithumb Documentation',
   u'Gael Pasgrimaud', 'wsgithumb', 'One line description of project.',
   'Miscellaneous'),
]
